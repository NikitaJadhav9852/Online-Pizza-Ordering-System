...
<?php
	...
	if(isset($_GET['previous_id']) && !empty($_GET['previous_id']))
	{
		...
		$qry=mysqli_query($dbcon,"SELECT * FROM users WHERE user_id='$previous_id'");
...
<body>
	...
	$qry=mysqli_query($dbcon,"SELECT * FROM orderdetails where user_id='$previous_id' and order_status='Ordered_Finished'");
