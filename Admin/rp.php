...
<body>
	...
	$qry=mysqli_query($dbcon,"select * from orderdetails,items, users where orderdetails.user_id=users.user_id and order_status='Ordered_Finished' and orderdetails.order_id='$select_name'") or die("fail");
