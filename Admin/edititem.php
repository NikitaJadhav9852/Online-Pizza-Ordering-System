...
mysqli_select_db($dbcon,"pizzademo");
	...
	{
		$id = $_GET['edit_id'];
		$query=mysqli_query($dbcon,"SELECT * FROM items WHERE item_id =$id");
	...
	$qry=mysqli_query($dbcon,"UPDATE items SET item_name='$item_name', item_price=$item_price, item_image='$item_image' WHERE item_id=$id") or die("afile".mysqli_error());
?>
                <script>
